...
function showMessage($msg){
    if ($msg == 1) {
      print "<p class='alert alert-success'>Registration Details Updated Successfully</p>";
    }
    if ($msg == 2) {
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <td style="width:130px;">'.$row_batch['batch_name'].'</td>
                          ...
                          <td style="width:200px;"><textarea disabled>'.$row_batch['comments'].'</textarea></td>
                           <td style="width:200px;">'.$row_batch['batch_fees'].'</td>';
                           if ($row_batch['is_paid'] == 1) {
                             print '<td style="width:200px;">Paid</td>';
                           }else{
                            print '<td style="width:200px;">Pending</td>';
                           }
                           print'
                           <td style="width:200px;">'.$row_batch['reg_date'].'</td>
                            <td style="width:200px;" id="button_action">
                            <a href="edit_registered_student.php?reg_id='.$row_batch['main_id'].'&page=paid" class="btn btn-success" >Edit</a></td>
                            </tr>';
                           $count++;
                        }
                      }
