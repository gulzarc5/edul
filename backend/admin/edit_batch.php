...
function getCenter($connection,$center_id){
  $sql = "SELECT * FROM `center` ORDER BY `id` DESC";
  if ($res = $connection->query($sql)) {

    while($center = $res->fetch_assoc()){
      if ($center['id'] == $center_id) {
        print '<option value="'.$center['id'].'" selected>'.$center['name'].'</option> <tr>';
      }else{
  ...
  if ($res = $connection->query($sql)) {
    ...
    while($course = $res->fetch_assoc()){
      if ($course['id'] = $course_id) {
        print '<option value="'.$course['id'].'" selected>'.$course['name'].'</option> <tr>';
      }else{
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <?php
          if (isset($_GET['b_id'])) {
            $sql_batch = "SELECT * FROM `batch` WHERE `id`='$_GET[b_id]'";
            if ($res_batch = $connection->query($sql_batch)) {
                $batch_row = $res_batch->fetch_assoc();

          ?>
          <form action="php/course/batch_update.php" method="post"  class="form-horizontal form-label-left">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control col-md-7 col-xs-12" name="center_id">
                  ...
                  <?php getCenter($connection,$batch_row['center_id']); ?>               
                </select>
              </div>              
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control col-md-7 col-xs-12" name="course_id">
                  <option>Please Select Course</option> 
                    <?php getCourse($connection,$batch_row['course_id']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="date" name="batch_start_date"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $batch_row['start_date']; ?>">
              </div>              
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="date" name="batch_end_date"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $batch_row['end_date']; ?>">
              </div>              
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="input-group date" id="myDatepicker3">
                  <input type="text" name="start_time" class="form-control" value = "<?php echo $batch_row['start_time']; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="input-group date" id="myDatepicker4">
                  <input type="text" name="end_time" class="form-control" value="<?php echo $batch_row['end_time']; ?>">
                    <span class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input cast="any" type="number" name="fees"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $batch_row['fees']; ?>">
              </div>              
            </div>
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" class="btn btn-success" name="edit_batch" value="edit_batch">Save</button>
              </div>
            </div>
          </form>
          <?php
