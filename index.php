				...
				<div class="row">
					<div class="col-sm-12 section-header-box">
						<div class="section-header section-header-l">
							<h2>welcome to EDULOUNGE</h2>
						</div><!-- ends: .section-header -->
					</div>
				</div>
				<p><p>We at Edulounge are a team of dedicated professionals having a vivid experience in the field of Education. Our mission is to provide a launching pad for students where they not only gain high quality education, but an overall inclusive growth.</p>
				<p>Edulounge is an intersection of disciplines which provides a perfect enviornment where students get superb support and guidance apart from step wise learning . The unique blend of outstanding mentoring and meticulous study.</p></p>	

				<a href="about-us.html" class="read_more-btn fa fa-long-arrow-right">read more</a>		
			</div><!-- Ends: . -->
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 video-play-btn" style="margin-top: 70px;">
				<iframe width="360" height="245" src="https://www.youtube.com/embed/0TsQU6HX-30" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>

			<div class="col-sm-6 video-play-btn" style="margin-top: 70px;">
				<iframe width="360" height="245" src="https://www.youtube.com/embed/FBqkXb9J2Yo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
		</div>
	</div>
</section>
...
<section class="courses-03" style="margin-top: 90px;">
	<h2 class="section-header" style="margin-bottom: 40px;">Buy PenDrive</h2>
	
	<div class="container">	
		<div class="row courses-r-margin-bottom" style="margin-bottom: 30px;">
			<div class="col-sm-4  single-courses-box">
			    <div class="single-courses">
					<a href="#">
						<div class="courses-img">
							<img src="images/index/p1.jpg" alt="" class="img-responsive">
						</div>
					</a>
					<div class="courses-price">
						<ul class="list-unstyled">
							<li class="courses-teacher"> <span style="font-size: 18px;">Coming Soon...</span></li>
							<!-- <li class="price-red">
						 	 	<span><i class="fa fa-money" aria-hidden="true"></i>155.00</span>
						 	 	<div class="base"></div>
							</li> -->								
						</ul>
					</div>
		...
		<div class="row">
			<div class="col-sm-6 col-md-3 single-book">
				<div class="publication-single-item">
					<a href="#"><img src="images/index/b1.jpg" alt="" class="img-responsive"></a>
					<div class="publication-text">
						<h4>Coming Soon...</h4>
						<!-- <ul class="list-unstyled">
							<li><i class="fa fa-money" aria-hidden="true"></i> 90</li>
...
<div class="container" style="margin-top: 30px; background-color: #8080800f;">
  <div class="row">
    <div class='col-md-offset-2 col-md-8 text-center'>
    <h2 style="margin-top: 30px;">OUR Testimonials</h2>
    <hr>
    </div>
  </div>
  <div class='row'>
